...
parser.add_argument('--my_fix_train', action='store_true', default=False)
...
def create_optimizer(model):
    if cfg.TRAIN.OPTIMIZER == 'adam':
        ...
        optimizer = OptimWrapper.create(
            optimizer_func, llr, get_layer_groups(model), wd=cfg.TRAIN.WEIGHT_DECAY, true_wd=True, bn_wd=True
        )
...
if __name__ == "__main__":
    ...
    # if args.my_fix_train:
    #     for name, value in model.named_parameters():
    #         if name.startswith("rpn.backbone_net.SA_modules"):
    #             value.requires_grad = True
    #         elif name.startswith("rpn.backbone_net.Img_Block"):
    #             value.requires_grad = True
    #         elif name.startswith("rpn.rpn_reg_layer"):
    #             value.requires_grad = True
    #         elif name.startswith("rpn.rpn_cls_layer"):
    #             value.requires_grad = True
    #         else:
