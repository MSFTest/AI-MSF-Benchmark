...
class Kitti2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            # 'GT_FOLDER': os.path.join(code_path, "datasets/kitti/train/image_02_train"),  # Location of GT data
            'GT_FOLDER': os.path.join(code_path, "/home/niangao/disk1/DeepFusionMOT/datasets/kitti/train"),  # Location of GT data
            # 'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/kitti/kitti_2d_box_train/'),  # Trackers location
            'TRACKERS_FOLDER': os.path.join(code_path, '/home/niangao/disk1/DeepFusionMOT/results/train/data'),  # Trackers location
