...
if __name__ == '__main__':
    suffix = "/home/niangao/disk1/JMODT/media"
    seq = 2 # the predict  result number  in
    viewer = KittiSequenceViewer(
        # root_dir='/media/Kitti/tracking/training',
        root_dir='{}/KITTI/tracking/training'.format(suffix),
        seq=seq,
        output_dir='jmodt',
        viewpoint_file='viewpoint.json',
        # label_dir='/media/Kitti/tracking/training/label_02 (jmodt)',
        label_dir='{}/KITTI/tracking/training/result'.format(suffix),
        radius=0.1,
        trajectory_len=20
    )
    ...
    create_video('jmodt', 'jmodt_{}.avi'.format(seq), (1440, 900))  # TODO: need to modify the width height
